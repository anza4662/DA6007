...
class NetW1(nn.Module):
    def __init__(self):
        super().__init__()
        self.lin1 = nn.Linear(5, 7)
        self.lin2 = nn.Linear(7, 8)
        self.lin3 = nn.Linear(8, 9)
        self.lin4 = nn.Linear(9, 10)
        self.lin5 = nn.Linear(10, 9)
        self.lin6 = nn.Linear(9, 8)
        self.lin7 = nn.Linear(8, 7)
        self.lin8 = nn.Linear(7, 5)
        ...
        self.bn5 = nn.BatchNorm1d(9)
        self.bn6 = nn.BatchNorm1d(8)
        self.bn7 = nn.BatchNorm1d(7)
        self.bn8 = nn.BatchNorm1d(5)
        self.bn9 = nn.BatchNorm1d(2)

        self.skip1 = nn.Linear(5, 8)
        self.skip2 = nn.Linear(8, 10)
        self.skip3 = nn.Linear(10, 8)
        self.skip4 = nn.Linear(8, 5)
